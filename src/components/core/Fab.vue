<template>
	<div class="adminActions">
		...
		<a class="adminButton" href="#!"><i class="fa fa-cog" /></a>
		<div class="adminButtons">
			<a href="#" title="Add Company"><i class="fa fa-building" /></a>
			<a href="#" title="Edit Company"><i class="fa fa-pen" /></a>
			<a href="#" title="Add User"><i class="fa fa-user-plus" /></a>
			<a href="#" title="Edit User"><i class="fa fa-user-edit" /></a>
		</div>
	</div>
</template>
